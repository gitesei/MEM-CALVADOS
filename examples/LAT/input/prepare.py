...
Lx = 12
Ly = Lx
area_per_lipid = eq_apl_dict['DOPC']
...
components.add(name='DOPC', molecule_type='lipid', nmol=int(N_lipids))
components.add(name=args.name, molecule_type='protein', nmol=1, ref_bead=2, pos_bead=[0,0,2.8], fixed_bead=True)
